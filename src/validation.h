...
CTransactionRef GetTransaction(const uint256 &hash, uint256 &hashBlock, bool fAllowSlow = false);
CTransactionRef GetTransaction(const uint256 &hash, bool fAllowSlow = false);
