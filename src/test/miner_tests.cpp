...
BOOST_AUTO_TEST_CASE(CreateNewBlock_validity)
{
    ...
    CScript scriptPubKey = CScript() << ParseHex("0414e9df27d2b41ad3c22f8ab8434519fcf716e051192b97f53f20f5c9b8e79bea76e1cbc50774618ca74ffd3ced75610e106944e83131e332a624e020217e4565") << OP_CHECKSIG;
    ...
    BOOST_CHECK(txFirst.size() > 0);
    if (txFirst.size() <= 0) return;
